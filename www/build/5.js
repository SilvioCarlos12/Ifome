...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__categoria__ = __webpack_require__(319);
...
var CategoriaPage = /** @class */ (function () {
    ...
    CategoriaPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-categoria',template:/*ion-inline-start:"/home/silvio/Documentos/aula/ricardofanetto-nofood-0dc5607b685d/NoFood.Ionic/src/pages/categoria/categoria.html"*/'<ion-content no-padding>\n  <div class="admin">\n    <button ion-button icon-only clear color="light" (click)="adminOptions()">\n      <ion-icon name="settings"></ion-icon>\n    </button>\n  </div>\n  <div class="blur"></div>\n  <p class="chamada">O que deseja comer hoje?</p>\n  <div class="categoria" *ngFor="let item of categorias | orderBy:\'titulo\'" (click)="selecionarProduto(item)" tappable>\n    <div class="imagem" [ngStyle]="{\'background-image\': \'url(\' + item.foto + \')\'}">\n\n    </div>\n    <p>\n      {{item.titulo}}\n    </p>\n  </div>\n\n</ion-content>'/*ion-inline-end:"/home/silvio/Documentos/aula/ricardofanetto-nofood-0dc5607b685d/NoFood.Ionic/src/pages/categoria/categoria.html"*/,
        }),
