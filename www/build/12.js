...
var AdmProdutosPage = /** @class */ (function () {
    ...
    AdmProdutosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-adm-produtos',template:/*ion-inline-start:"/home/silvio/Documentos/aula/ricardofanetto-nofood-0dc5607b685d/NoFood.Ionic/src/pages/adm-produtos/adm-produtos.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>Produtos</ion-title>\n    <ion-buttons right>\n      <button ion-button icon-only (click)="addOrEdit({})">\n        <ion-icon name="add"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n<ion-content no-padding>\n  <ion-list lines *ngIf="!isLoading">\n    <ion-item text-wrap *ngIf="lista.length == 0">\n      Você não tem nenhum produto cadastrado.\n    </ion-item>\n    <ion-item *ngFor="let item of lista" text-wrap (click)="addOrEdit(item)">\n      {{ item.nome }}\n      <ion-note item-end>\n        {{ item.categoriaId.titulo }}\n      </ion-note>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"/home/silvio/Documentos/aula/ricardofanetto-nofood-0dc5607b685d/NoFood.Ionic/src/pages/adm-produtos/adm-produtos.html"*/,
        }),
